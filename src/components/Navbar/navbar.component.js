        ...
        <>
            <div className="container mx-auto flex items-center justify-between">
                ...
                <div className="flex items=center gap-3">
                    <span className="text-gray-300 text-lg flex items-center hover:text-white font-medium cursor-pointer">
                        Bhubaneshwar
                        <BiChevronDown />
                    </span>
                    <button className="bg-red-600 text-white text-sm rounded px-5 py-1">
                        Sign in
                    </button>
