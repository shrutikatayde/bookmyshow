...
const Plays = () => {
    return (
        <>
            <div className="container mx-auto px-1 mt-16">
                <div className="w-full lg:flex lg:flex-row-reverse ">
                    <div className="lg:w-9/12"><h2 className="text-3xl font-bold mb-4 text-navCol-500">Plays in Amravati</h2>
                    ...
                    <div className="lg:w-1/4 ">
                        <h2 className="text-3xl font-bold mb-4 text-navCol-500">
                            Filters
                        </h2>
                        <div>
